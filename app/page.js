            ...
            <div className="hero__content">
              ...
              >
                <motion.div whileHover={{ scale: 1.05 }} className="banner-btn1">
                  <a className="inline-block bg-blue-600  px-6 py-3 rounded-full hover:bg-blue-700 transition-colors text-color" href="#" style={{color: '#fff'}}>Hire Me Now</a>
                </motion.div>
                  ...
                  <div className="hero-content text-center">
                    ...
                    >
                      <motion.img
                        ...
                        src="/2022116.jpg"
                        srcset="image-4k.jpg 2x, image-8k.jpg 3x" 
                        onError={(e) => {
